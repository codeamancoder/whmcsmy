<?php /* Smarty version 2.6.28, created on 2017-04-03 13:59:45
         compiled from original/menu.tpl */ ?>
<li><a href="index.php" title="Home"><?php echo $this->_tpl_vars['_ADMINLANG']['home']['title']; ?>
</a>
  <ul>
    <li><a href="index.php"><?php echo $this->_tpl_vars['_ADMINLANG']['global']['hometitle']; ?>
</a></li>
    <li><a href="myaccount.php"><?php echo $this->_tpl_vars['_ADMINLANG']['global']['myaccount']; ?>
</a></li>
    <li><a href="logout.php"><?php echo $this->_tpl_vars['_ADMINLANG']['global']['logout']; ?>
</a></li>
  </ul>
</li>
<li><a <?php if (in_array ( 'List Clients' , $this->_tpl_vars['admin_perms'] )): ?>href="clients.php"<?php endif; ?> title="Clients" id="Menu-Clients"><?php echo $this->_tpl_vars['_ADMINLANG']['clients']['title']; ?>
</a>
  <ul>
    <?php if (in_array ( 'List Clients' , $this->_tpl_vars['admin_perms'] )): ?><li><a href="clients.php" id="Menu-Clients-View_Search_Clients"><?php echo $this->_tpl_vars['_ADMINLANG']['clients']['viewsearch']; ?>
</a></li><?php endif; ?>
    <?php if (in_array ( 'Add New Client' , $this->_tpl_vars['admin_perms'] )): ?><li><a href="clientsadd.php" id="Menu-Clients-Add_New_Client"><?php echo $this->_tpl_vars['_ADMINLANG']['clients']['addnew']; ?>
</a></li><?php endif; ?>
    <?php if (in_array ( 'List Services' , $this->_tpl_vars['admin_perms'] )): ?>
    <li class="expand"><a href="clientshostinglist.php" id="Menu-Clients-Products_Services"><?php echo $this->_tpl_vars['_ADMINLANG']['services']['title']; ?>
</a>
        <ul>
...
<li><a id="Menu-Support" <?php if (in_array ( 'Support Center Overview' , $this->_tpl_vars['admin_perms'] )): ?>href="supportcenter.php"<?php endif; ?> title="Support"><?php echo $this->_tpl_vars['_ADMINLANG']['support']['title']; ?>
  ...
  <ul>
    ...
    <?php if (in_array ( 'List Support Tickets' , $this->_tpl_vars['admin_perms'] )): ?><li class="expand"><a id="Menu-Support-Support_Tickets" href="supporttickets.php"><?php echo $this->_tpl_vars['_ADMINLANG']['support']['supporttickets']; ?>
        ...
        <li><a id="Menu-Support-Support_Tickets-Customer_Reply" href="supporttickets.php?view=Customer-Reply">- Customer-Reply</a></li>
