<?php /* Smarty version 2.6.28, created on 2017-04-07 00:06:30
         compiled from /home/fibosoft/hosting/public_html/templates/default/knowledgebase.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', '/home/fibosoft/hosting/public_html/templates/default/knowledgebase.tpl', 36, false),)), $this); ?>
    ...
    <div class="textcenter">
        <form method="post" action="knowledgebase.php?action=search" class="form-inline">
            <fieldset class="control-group">
                <input class="bigfield" name="search" type="text" value="<?php echo $this->_tpl_vars['LANG']['kbquestionsearchere']; ?>
...
' : this.value;"/>
                <input type="submit" class="btn btn-large btn-primary" value="<?php echo $this->_tpl_vars['LANG']['knowledgebasesearch']; ?>
" />
            </fieldset>
        </form>
    </div>
