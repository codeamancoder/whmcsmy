...
function v5310Upgrade() {
	...
	$message = '&lt;p&gt;Dear {$client_name},&lt;/p&gt;' . PHP_EOL . '&lt;p&gt;We are pleased to confirm that your recent domain transfer has now been completed.&lt;/p&gt;' . PHP_EOL . '&lt;p&gt;Order Date: {$domain_reg_date}&lt;br /&gt;' . 'Domain: {$domain_name}&lt;br /&gt;Status: {$domain_status}&lt;/p&gt;' . PHP_EOL . '&lt;p&gt;You may now login to your client area at {$whmcs_link} to manage your domain.&lt;/p&gt;' . PHP_EOL . '&lt;p&gt;{$signature}&lt;/p&gt;';
	$query   = 'INSERT INTO `tblemailtemplates` (`id`, `type`, `name`, `subject`, `message`, `attachments`, `fromname`, `fromemail`, `disabled`, `custom`, `language`, `copyto`, `plaintext`) VALUES
