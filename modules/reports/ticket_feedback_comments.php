...
while ($data = mysql_fetch_array($result)) {
    ...
    $reportdata["tablevalues"][] = array('<a href="supporttickets.php?action=viewticket&id='.$ticketid.'" target="_blank">'.$tickettid.'</a>',$adminname,$subject,$datetime,$rating,nl2br($comments),'<a href="http://nullrefer.com/?http://www.geoiptool.com/en/?IP='.$ip.'" target="_blank">'.$ip.'</a>');
