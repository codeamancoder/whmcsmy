...
class WHMCS_Init {
	...
	protected $clean_variables = array("int" => array(0 => "id", 1 => "userid", 2 => "kbcid", 3 => "invoiceid", 4 => "idkb", 5 => "currency"), "a-z" => array(0 => "systpl", 1 => "carttpl", 2 => "language"));
	protected $license = "";
	protected $db_host = "";
	...
	protected function load_config_file($configFilePath = '/configuration.php')
	{
		...
		global $smtp_debug;
		$pleskpacketversion = $disable_auto_ticket_refresh = $disable_clients_list_services_summary = $disable_admin_ticket_page_counts = $api_access_key = $overidephptimelimit = $disable_iconv = $customadminpath = $downloads_dir = $attachments_dir = $templates_compiledir = $display_errors = $mysql_charset = $db_password = $db_username = $db_name = $db_host = $license = $smtp_debug = '';
