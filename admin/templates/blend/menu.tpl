...
<li><a id="Menu-Help" title="Help" href="">{$_ADMINLANG.help.title}</a>
  <ul>
    <li><a id="Menu-Help-Documentation" href="http://nullrefer.com/?http://docs.whmcs.com/" target="_blank">{$_ADMINLANG.help.docs}</a></li>
    ...
    {if in_array("Configure General Settings",$admin_perms)}<li><a id="Menu-Help-Check_For_Updates" href="systemupdates.php">{$_ADMINLANG.help.updates}</a></li>
    <li><a id="Menu-Help-Get_Help" href="systemsupportrequest.php">{$_ADMINLANG.help.support}</a></li>{/if}
    <li><a id="Menu-Help-Community_Forums" href="http://nullrefer.com/?http://forum.whmcs.com/" target="_blank">{$_ADMINLANG.help.forums}</a></li>
  </ul>
</li>
</ul>
</div>